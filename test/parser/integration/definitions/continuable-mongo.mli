...
type Collection<T> : {
    ...
    remove: (selector: Object, options?: Object) => Continuable<Number>,
    update: (
        selector: Object,
        doc?: Object,
        options?: Object
...
continuable-mongo/cursor :
    (Collection<T>, selector: Object, options?: Object) => Cursor<T>

continuable-mongo/collection :
    (Client) => (collectionName: String) => Collection
